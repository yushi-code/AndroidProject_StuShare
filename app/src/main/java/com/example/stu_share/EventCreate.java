...
public class EventCreate extends AppCompatActivity {
    ...
    private User user;
    private EventCoordinator.Event event1=null;
    ...
    private void createEvent() {
        ...
        event1.setOrgID(user.id);
        dbHelper.createEvent(event1,"https://w0044421.gblearn.com/stu_share/create_event.php");
        Toast.makeText(getApplicationContext(), "Registered", Toast.LENGTH_SHORT).show();
        Log.d("STATUS",event1.toString());
        Log.d("STATUS",event1.orgID);
    }
